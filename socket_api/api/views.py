...
def join(sid, message):
    ...
    sio.emit('my_response', {'data': 'Enteredisconnect_requestd room: ' + message['room']},
             room=sid)
...
def get_games(sid):
    ...
    sio.emit('my_response', {'data': games})


@sio.event
def get_uuid(sid, message):
    games = serializers.serialize(
...
def create_game(sid):
    ...
    new_game.save()
    sio.emit('my_response', {'data': serializers.serialize(
